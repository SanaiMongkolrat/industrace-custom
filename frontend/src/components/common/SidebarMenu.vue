...
const menuSections = computed(() => {
  ...
  if (canRead('lifecycle_statuses')) managementItems.push({ label: t('menu.navigation.lifecycleStatuses'), icon: 'pi-sync', to: '/lifecycle-statuses' })
  if (canRead('model_lifecycles')) managementItems.push({ label: t('menu.navigation.modelLifecycles'), icon: 'pi-calendar', to: '/model-lifecycles' })
